    ...
    >
      <div className="flex items-center">
        ...
        <div className="flex-1">
          <h3 className="font-medium transition-all duration-200 group-hover:translate-x-0.5">Bank Transfer</h3>
          <p className="text-sm opacity-70 transition-all duration-200 group-hover:translate-x-0.5">2-3 business days</p>
        </div>
        {selected ? (
          <div 
