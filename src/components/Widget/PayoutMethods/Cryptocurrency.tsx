    ...
    >
      <div className="flex items-center">
        ...
        <div className="flex-1">
          <h3 className="font-medium transition-all duration-300 group-hover:translate-x-0.5">Cryptocurrency</h3>
          <p className="text-sm opacity-70 transition-all duration-300 group-hover:translate-x-0.5">Instant transfer</p>
        </div>
        {selected ? (
          <div 
