...
import { ArrowRight, Wallet, Clock, CheckCircle } from 'lucide-react';
    ...
    <div className="welcome-container">
      <div className="text-center mb-6">
        ...
        <p className="text-sm opacity-80">
          <span className="font-medium">{config.companyName || "Acme Inc."}</span> would like to pay you
        </p>
      ...
      <div className="space-y-4 mb-6">
        <div className="flex items-start gap-3 p-3 rounded-lg bg-white/5">
          ...
          <div>
            <h3 className="text-sm font-medium">Quick Payment</h3>
            <p className="text-xs opacity-70">Choose from multiple payout methods</p>
          </div>
        </div>
