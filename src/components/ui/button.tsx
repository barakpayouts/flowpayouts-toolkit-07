  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap text-sm font-medium transition-all duration-300 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        outline:
          "border border-input bg-background text-foreground hover:bg-accent hover:text-accent-foreground hover:border-accent",
        secondary:
        ...
        // Adding new high contrast variants
        purple: 
          "bg-[#9b87f5] text-white font-medium shadow-md hover:bg-[#8B5CF6] hover:shadow-lg hover:-translate-y-0.5 transition-all duration-300",
        blue: 
        ...
        dark: 
          "bg-[#1A1F2C] text-white font-medium shadow-md hover:bg-[#1A1F2C]/90 hover:shadow-lg hover:-translate-y-0.5 transition-all duration-300",
      },
      size: {
