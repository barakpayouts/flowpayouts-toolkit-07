        ...
        <div className="flex justify-between items-center mb-8">
          <div className="flex items-center gap-2">
            <Button 
              ...
              size="sm" 
              onClick={() => navigate('/')}
              className="rounded-full flex items-center gap-1 text-sm text-white hover:bg-black/40"
            >
              <ArrowLeft size={14} />
              Back
            </Button>
                ...
                <div className="flex justify-between items-center mb-4">
                  ...
                  <div className="flex items-center gap-2">
                    <Button 
                      ...
                      variant="dark"
                      size="sm"
                      className="flex items-center gap-1 text-white hover:bg-black/40"
                  ...
                  <TabsContent value="styling" className="space-y-4 animate-fade-in">
                    ...
                    <div className="pt-4">
                      <Button 
                        ...
                        className="w-full text-white hover:bg-black/40"
                      >
                        Reset to Defaults
                      </Button>
                    </div>
